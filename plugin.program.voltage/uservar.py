...
ADDONTITLE     = '[B][COLOR slateblue]Voltage[/COLOR][/B] Wizard'
BUILDERNAME    = 'Voltage'
...
THEME1         = '[COLOR '+COLOR1+'][B][I]([COLOR '+COLOR2+']Voltage[/COLOR])[/I][/B][/COLOR] [COLOR '+COLOR2+']%s[/COLOR]'
...
# Font size of header
FONTHEADER     = 'Font14'
HEADERMESSAGE  = '[B][COLOR dodgerblue]Voltage[/COLOR][/B] Wizard'
